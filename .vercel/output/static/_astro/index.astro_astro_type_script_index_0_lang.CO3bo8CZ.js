import{c}from"./createBrowserClient.DLvzPopl.js";function l(){return c("https://pujvlziaqfsyjwtkbgxt.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB1anZsemlhcWZzeWp3dGtiZ3h0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc0OTIwNzUsImV4cCI6MjA5MzA2ODA3NX0.OfOjbMAG6PUP6pG2Gyb25M1wAMlGAKde_IyWVmfMtUU")}async function u(){const t=document.getElementById("queue-container");if(t)try{const r=await l(),{data:n,error:s}=await r.from("profiles").select("*, campuses(name)").eq("is_approved",!1).eq("is_admin",!1).order("created_at",{ascending:!1});if(s)throw s;if(!n||n.length===0){t.innerHTML='<div class="empty-state">No pending registrations.</div>';return}t.innerHTML=`
